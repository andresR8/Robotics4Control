...
#define __LEDS_H__
	...
	/* Public Interface - May be used in end-application: */
		/* Macros: */
			...
			#define LEDS_LED1        (1 << PB6) //Green LED

			/** LED mask for the second LED on the board. */
			#define LEDS_LED2        (1 << PB7)  
		...
		/* Inline Functions: */
			...
			static inline void LEDs_MessageTurnOffLEDs(const uint8_t LEDMask)
			{
				PORTD&= ~LEDS_LED3;
			}
			
			static inline void LEDs_MessageTurnOnLEDs(const uint8_t LEDMask)
			{
				PINB  = LEDMask;
			}
