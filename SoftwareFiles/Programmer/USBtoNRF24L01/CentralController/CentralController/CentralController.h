...
/** \file
 *
 *  Header file for CentralController.c.
 */
...
#define CENTRALCONTROLLER_H_
	...
	/* Includes: */
		...
		#include "Wireless/spi.h"
		#include "Wireless/nrf24l01.h"
		#include "Wireless/nrf24l01registers.h"
	...
	/* Macros: */
		...
		#define LEDMASK_USB_ENUMERATING  (LEDS_LED2 | LEDS_LED2)
	...
	/* Function Prototypes: */
		...
		void processAndSendtoWireless(void);
