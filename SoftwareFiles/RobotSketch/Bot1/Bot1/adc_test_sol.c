	...
	{	
		...
		if (i==0)
		{
			...
			if (adc_temp < 256)
				PORTD=(0x08|m);
				//PORTLEDS=(REF1|LED4);
			else if (adc_temp > 256 && adc_temp < 512)
				PORTLEDS=(REF1|LED3);
			else if (adc_temp > 512 && adc_temp < 768)
				PORTLEDS=(REF1|LED2);
			else if (adc_temp > 768)
				PORTLEDS=(REF1|LED1);
		}
		else if (i==1)
		{
		...
		else if (i==2)
		{
			...
			if (adc_temp < 256)
				...
				PORTLEDS=(REF1|LED3|LED4);
			else if (adc_temp > 512 && adc_temp < 768)
				PORTLEDS=(REF1|LED2|LED3|LED4);
			else if (adc_temp > 768)
				PORTLEDS=(REF1|LED1|LED2|LED3|LED4);
		}
		else if (i==3)
		{
			// SECUENCIA 3
